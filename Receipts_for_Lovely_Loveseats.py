# 1) Create a variable called lovely_loveseat_description and assign to it the following string: 'Lovely Loveseat. Tufted polyester blend on wood. 32 inches high x 40 inches wide x 30 inches deep. Red or white.':
...
# 3) Let’s extend our inventory. Create a variable called stylish_settee_description and assign to it the following string: 'Stylish Settee. Faux leather on birch. 29.50 inches high x 54.75 inches wide x 28 inches deep. Black.':
...
# 5) We just need one more item before we’re ready for business. Create a new variable called luxurious_lamp_description and assign it the following: Luxurious Lamp. Glass and iron. 36 inches tall. Brown with cream shade:
...
# 20) Congratulations! You created our catalog and served our first customer. You used your knowledge of strings and numbers to create and update variables. We are now able to print out an itemized list and a total cost for our customer. Lovely!
